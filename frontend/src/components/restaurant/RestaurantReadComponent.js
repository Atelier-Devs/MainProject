// src/components/restaurant/RestaurantReadComponent.js
import React from "react";
import { useLocation } from "react-router-dom";

const RestaurantReadComponent = () => {
    ...
    return (
        <div className="max-w-5xl w-full bg-white shadow-lg rounded-lg overflow-hidden flex">
            ...
            <div className="p-8 w-2/5 flex flex-col justify-between">
                <div>
                    <h2 className="text-3xl font-semibold">{title || "레스토랑 이름"}</h2>
...
export default RestaurantReadComponent;
