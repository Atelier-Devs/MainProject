...
const bakeries = [
    ...
    },
    {
        ...
        description: "달콤하고 향기로운 제철 딸기가 풍부한 ATELIER 의 시그니쳐 딸기 케이크.",
        image: bakery4,
    },
    {
        id: 5,
    ...
    return (
        <div className="max-w-5xl mx-auto p-4 pb-24">
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-4">
                {bakeries.map((bakery) => (
                    <div key={bakery.id} className="bg-white shadow-md rounded-lg overflow-hidden">
                        <div className="relative">
                            <img src={bakery.image} alt={bakery.title} className="w-full h-52 object-cover" />
                        </div>
                        <div className="p-3">
                            ...
                            <div className="mt-3 flex justify-end">
                                <button
                                    ...
                                    onClick={() => navigate(`/bakery/${bakery.id}`, { state: { bakery } })}
                                >
                                    주문하기 &gt;
                                </button>
                            </div>
