            ...
            <div className="flex-grow flex items-center justify-center py-16">
                <div className="max-w-5xl w-full bg-white shadow-lg rounded-lg overflow-hidden flex">
                    ...
                    <div className="p-8 w-2/5">
                        <h2 className="text-3xl font-semibold">{bakery.title}</h2>
                        <p className="text-gray-700 mt-3">{bakery.description}</p>
                        <div className="mt-5 text-xl font-bold">가격: {bakery.price} KRW</div>
