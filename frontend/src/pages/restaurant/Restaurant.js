...
const restaurants = [
  ...
  },
  {
    ...
    title: "스테이크 뷔페",
    description:
      "최상급 스테이크와 다채로운 고기 요리를 무제한으로 즐기는 미식의 향연",
    image: restaurant2,
  },
  {
    id: 3,
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(`/restaurant/${restaurant.id}`, {
                      state: {
                        ...restaurant,
                        price: restaurantPriceMap[restaurant.title],
                      },
                    })
                  }
                >
                  {Number(restaurantPriceMap[restaurant.title]).toLocaleString()} KRW &gt;
                </button>
              </div>
            </div>
          </div>
