        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex-grow flex items-center justify-center py-16">
                <div className="max-w-5xl w-full bg-white shadow-lg rounded-lg overflow-hidden flex">
                    ...
                    <img src={room.image} alt={room.title} className="w-3/5 object-cover" />
                    <div className="p-8 w-2/5">
                        ...
                        <div className="mt-5 text-xl font-bold">가격: {room.price} KRW</div>
                        <form className="mt-6 space-y-5">
                            <div>
                                <label className="block text-sm font-medium text-gray-700">체크인 날짜</label>
                                <input type="date" className="mt-2 p-3 w-full border rounded-md" required />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700">체크아웃 날짜</label>
                                <input type="date" className="mt-2 p-3 w-full border rounded-md" required />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700">인원</label>
                                <input type="number" min="1" max="10" className="mt-2 p-3 w-full border rounded-md" required />
                            </div>
