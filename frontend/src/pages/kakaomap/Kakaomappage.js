...
const KakaomapPage = () => {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 mt-24 pb-24 max-w-4xl">
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold text-[#5c4631] mb-2">오시는 길</h2>
          <p className="text-[#8a6d49] text-xs">ATELIER 호텔 위치 안내</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* 소개 영역 */}
          <div className="bg-[#f8efe6] rounded-2xl shadow-md p-6 text-[#5c4631]">
            <h3 className="text-xl font-semibold mb-4">Atelier 호텔 소개</h3>
